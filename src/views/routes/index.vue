<template>
  <div>
    <div class="col-12 row">
      <div class="col-xs-12 col-sm-auto q-table__title text-h6">Routes list</div>
    </div>
    <div class="col-12 row">
      <div class="col">
      ...
      <div class="col-xs-5 col-sm-5 col-md-4">
        <q-input v-model="filter" :dense="denseInput" debounce="500"
    ...
    <!-- <q-tree ref="routes" class="col-12 col-sm-6" :nodes="items" :dense="denseInput" node-key="name"
    ...
    <tm-tree :nodes.sync="items" node-key="_id" label="label" :no-nodes-label="$t('table.no_data')"
      :selected.sync="selected" :ticked.sync="ticked" :expanded.sync="expanded"
      tick-strategy="leaf-filtered" :draggable="true" :filter-method="onFilter" :filter="filter"
  ...
  methods: {
    onSelect(props) {
      ...
      api.select().then((x) => {
        ...
        this.items = treeRouters.generateRoutes(x.data)
      })
    },
